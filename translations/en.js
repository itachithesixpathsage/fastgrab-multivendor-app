export const en = {
  ...
  welcome:
    "Welcome to Fastgrab, sometimes all you need is love. But a little food now and then doesn't hurt.",
  welcomeScreen: 'Welcome to Fastgrab',
  loginBtn: 'Login',
  ...
  brandName: 'Fastgrab',
  welcomeText: 'Welcome to Fastgrab',
  createAccountDesc:
  ...
  exploreYallaCities: 'Explore Fastgrab Cities',
  Card: 'Card',
